...
// NOTE: PROJECTS array still references image imports.
// Import images in the file that uses PROJECTS, then pass them in,
// OR keep PROJECTS defined in ProjectsSection.jsx alongside the imports.
// We export a helper to build PROJECTS so images can be injected.
export const buildProjects = (images) => {
  const { od, ap, ne } = images;
  return [
    {
      id: 1,
